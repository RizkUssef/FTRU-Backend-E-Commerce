    ...
    <section class="man_product">
        <div class="title">
            ...
            <div class="sub_category_links">
                ...
                <div class="dropdown-content">
                    ...
                    @endphp
                    <a href="{{route('one subcategory',['category_name'=>$category->name,'subcategory_name'=>$subcate->name])}}">{{$show_allsubname}}</a>
                    @endforeach
                </div>
            </div>
        </div>
        @foreach ($subcategory->subcategoryProduct as $product)
            <div class="first_product">
                <a href="{{route('one product',['category_name'=>$category->name,'subcategory_name'=>$subcategory->name,'product_id'=>$product->id])}}">
                    <div class="inner_bg">
