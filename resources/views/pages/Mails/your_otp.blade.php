...
<html lang="en">
    <head>
        ...
        <style>
            ...
            padding: 5px 7px;
            border-radius: 8px;
            border-color:rgba(63, 64, 69,0.2);
            border-style: solid;
            color: #3F4045;
            display: block;
            margin: auto;
    ...
    <body style="font-family: 'Karantina', cursive; background-color: #E9E8DE; border-radius: 25px; padding: 30px 0px">  
        <section class="bg">
            <section class="email_container">
                <section class="tlogo" >
                    <div class="top_logo">
                        <img src="{{$message->embed(public_path("img/logo/FTRU (5).png"))}}" alt="no">
                    </div>
                </section>
            ...
            <p class="text_for">Hello my Friend, this is your OTP keep it to verify your email</p>
                    </div>
                    <div class="error_image">
                        <img src="{{$message->embed(public_path("img/illast/Two factor authentication-bro.png"))}}" alt="no" >
                    </div>                
                    <h1>{{$data["otp"]}}</h1>
                </div>
                <div class="hint">
                ...
                <div class="bottom_logo">
                    <img src="{{$message->embed(public_path("img/logo/Component 22.png"))}}" alt="no">
                </div>
            </section>
        </section>
